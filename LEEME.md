...
contenido ya corre: las nueve unidades pasan con 0 errores.

**Las nueve unidades están escritas (M6 a M13).** 4.103 preguntas y 37 formas
de conjugación. Lo que queda es la revisión humana de cada unidad con el libro
al lado, y lo que el uso diga.
...
`INFORME-M6.md`, `INFORME-M7.md`, `INFORME-M8-M12.md` y `INFORME-M13.md`). Lo que ya se
